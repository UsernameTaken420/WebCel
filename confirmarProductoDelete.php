...
<html>
  ...
  <body>
    ...
    <div class="maintext">
      <form id="addPRO" action="DelProducto.php" method="POST">
        <table>
          <tr>
          ...
          <tr>
            <td>Pa&iacute;s</td>
            <td>
              <select id="paisPRO" name="PAI" disabled>
          ...
          <tr>
            ...
            <td>
              <select id="catPRO" name="CAT" disabled>
          ...
          <td colspan="2">
            ...
            <input type="button"  value="Cancelar" onclick="window.location.replace('productoDel.php');"/>
          </td>
        </tr>
        </table>
      </form>
